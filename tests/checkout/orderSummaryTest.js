...
describe('test suite: renderOrderSummary',()=>{
  ...
  it('Updating the delivery option',()=>{
     ...
     expect(cart.length).isEqual(2);
     expect(cart[0].productId).isEqual(productId1);
     expect(cart[0].deliveryOptionId).isEqual('3');
     expect(document.querySelector(`.js-shipping-price`)).isEqual(`$14.98`);
     expect(document.querySelector(`.js-total-price`)).isEqual(`63.50`);
  });
});